...
class RelativeAttention(nn.Module):
    ...
    def get_Er_t(self, seq_len):
        raise(NotImplementedError("get_Er_t is not implemented"))
...
class ClippedRelativeAttention(RelativeAttention):
    def __init__(self, d_model, num_heads, clip_dist, max_len=1024, dropout=0.1):
        super(ClippedRelativeAttention, self).__init__(d_model, num_heads, max_len, dropout)
